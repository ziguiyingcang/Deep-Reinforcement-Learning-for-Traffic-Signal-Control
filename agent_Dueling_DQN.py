...
class TestAgent():
    ...
    def _build_model(self):
        ...
        action_advantage = Lambda(lambda a: a[:, :] - K.mean(a[:, :], 
            keepdims = True), output_shape = (self.action_space,))(action_advantage)
    ...
    def replay(self):
        ...
        with open('q_value_dueling_dqn.txt', 'a', encoding = 'utf-8') as a:
            a.write(avg_q_value + "\n")
        a.close()
        #
        ...
        with open('loss_dueling_dqn.txt', 'a', encoding = 'utf-8') as f:
            f.write(train_loss + "\n")
        f.close()
        #
