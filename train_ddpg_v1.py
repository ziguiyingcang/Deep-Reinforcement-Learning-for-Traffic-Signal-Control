...
def train(agent_spec, simulator_cfg_file, gym_cfg, metric_period):
    ...
    for e in range(args.episodes):
        ...
        while i < args.steps:
            ...
            #if total_decision_num > agent.learning_start and total_decision_num % agent.update_target_model_2_freq == agent.update_target_model_2_freq - 1:
            #    agent.update_target_network_2()
            #if total_decision_num > agent.learning_start and total_decision_num % agent.update_target_model_3_freq == agent.update_target_model_3_freq - 1:
            #    agent.update_target_network_3()
            if all(dones.values()):
