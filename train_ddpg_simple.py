...
def load_agent_submission(submission_dir: Path):
    ...
    for dirpath, dirnames, file_names in os.walk(submission_dir):
        for file_name in [f for f in file_names if f.endswith(".py")]:
            if file_name == "agent_DDPG_simple.py":
                module_path = dirpath
    ...
    ), "Cannot find file named agent_DDPG_simple.py, please check your submission zip"
    assert(
    ...
    import agent_DDPG_simple as agent_submission
